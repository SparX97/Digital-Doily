...
public class DrawingPanel extends JPanel {
    ...
    private void drawCurrent(Graphics2D g, ArrayList<Line> lines) {
    ...
    protected void drawToBufferedImage() {
    ...
    private void addLines(ArrayList<Line> list) {
